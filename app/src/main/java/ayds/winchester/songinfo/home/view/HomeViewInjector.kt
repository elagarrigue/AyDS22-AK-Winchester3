...
object HomeViewInjector {
    private val resultReleaseDate : ResultReleaseDate = ResultReleaseDateImpl()
    val songDescriptionHelper: SongDescriptionHelper = SongDescriptionHelperImpl(resultReleaseDate)
